...
function* integerFromBoxedString(
  ...
  //unbox and try again
  return yield* wrapWithCases(dataType, input.valueOf(), wrapOptions, integerFromStringCases);
}

function* integerFromIntegerValue(
  dataType: IntegerOrEnumType,
  input: unknown,
  wrapOptions: WrapOptions
): Generator<never, IntegerOrEnumValue, WrapResponse> {
...
function* integerFromDecimalValue(
  dataType: IntegerOrEnumType,
  input: unknown,
  wrapOptions: WrapOptions
): Generator<never, IntegerOrEnumValue, WrapResponse> {
...
function* enumFromEnumTypeValueInput(
  ...
  return <Format.Values.EnumValue>(yield* wrapWithCases(
    dataType,
    input.value,
    { ...wrapOptions, loose: true },
    integerCasesBasic
