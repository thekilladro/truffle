...
export function isUint8ArrayLike(
  input: any
): input is Uint8ArrayLike {
  return (
...
export function isHexString(input: string): boolean { //(with prefix, to be clear)
...
export function isBoxedPrimitive(input: any): input is String|Number|Boolean {
